...
const STATIC: Array<{ path: string; priority: number; changeFrequency: MetadataRoute.Sitemap[number]['changeFrequency'] }> = [
  ...
  { path: '/jobs/panchakarma-jobs',         priority: 0.85, changeFrequency: 'daily' },
  { path: '/jobs/kayachikitsa-jobs',        priority: 0.85, changeFrequency: 'daily' },
  { path: '/jobs/shalya-jobs',              priority: 0.8, changeFrequency: 'daily' },
  { path: '/jobs/prasuti-tantra-jobs',      priority: 0.8, changeFrequency: 'daily' },
  { path: '/jobs/wellness-consultant-jobs', priority: 0.8, changeFrequency: 'daily' },
