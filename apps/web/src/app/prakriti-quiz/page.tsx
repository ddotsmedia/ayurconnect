    ...
    return (
      <>
        ...
        <section className="container mx-auto px-4 py-10 max-w-3xl">
          <div className="bg-gradient-to-br from-kerala-50 via-white to-amber-50 border border-kerala-100 rounded-card p-6 md:p-8 shadow-card flex flex-col md:flex-row items-start md:items-center gap-4">
            <div className="flex-1">
              <p className="text-[10px] uppercase tracking-wider text-kerala-700 font-semibold">Recommended next</p>
              <h3 className="font-serif text-xl md:text-2xl text-ink mt-1">Generate your seasonal regimen</h3>
              <p className="text-sm text-gray-700 mt-2 leading-relaxed">
                Your prakriti × today&apos;s Ritu × your local climate (Gulf, UK, US, Australia all supported). Ahara, Vihara, Dinacharya, herbs — printable + shareable.
              </p>
            </div>
            <Link href="/ritucharya" className="inline-flex items-center gap-1.5 px-5 py-2.5 bg-kerala-700 hover:bg-kerala-800 text-white rounded text-sm font-semibold whitespace-nowrap">
