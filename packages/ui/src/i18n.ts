...
export const STRINGS = {
  en: {
    nav: { doctors: 'Doctors', hospitals: 'Hospitals', herbs: 'Herbs', ayurbot: 'AyurBot', forum: 'Forum', jobs: 'Jobs', tourism: 'Tourism', login: 'Login', joinFree: 'Join Free', menu: 'Menu', viewAll: 'View all 500+ doctors', bySpec: 'By Specialization', byDistrict: 'By District' },
    hero: {
  ...
  ml: {
    nav: { doctors: 'ഡോക്ടർമാർ', hospitals: 'ആശുപത്രികൾ', herbs: 'ഔഷധസസ്യങ്ങൾ', ayurbot: 'ആയുർബോട്ട്', forum: 'ചർച്ച', jobs: 'ജോലികൾ', tourism: 'ടൂറിസം', login: 'പ്രവേശിക്കുക', joinFree: 'സൗജന്യ അംഗത്വം', menu: 'മെനു', viewAll: 'എല്ലാ 500+ ഡോക്ടർമാരെയും കാണുക', bySpec: 'വിദഗ്ധത പ്രകാരം', byDistrict: 'ജില്ല പ്രകാരം' },
    hero: {
