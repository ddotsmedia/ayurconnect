...
import {
  ...
  Newspaper, Ticket, Briefcase, Bot, FileText, Users,
} from 'lucide-react'
...
export function Navbar({ session = null }: { session?: NavbarSession } = {}) {
  ...
  const NAV_LINKS: NavItem[] = [
    ...
    {
      kind: 'group', key: 'jobs', label: tr.nav.jobs, href: '/jobs', cols: 1,
      sections: [{
        items: [
          ...
          { href: '/jobs/talent',              label: 'Talent directory',     desc: 'Browse verified BAMS candidates',                icon: Users },
          { href: '/jobs/interview-questions', label: 'Interview questions',  desc: 'AI-generated by role & specialty',               icon: Bot },
          { href: '/jobs/career-advisor',      label: 'Career advisor',       desc: 'Personalized guidance (AI)',                     icon: Bot },
          { href: '/jobs/resume-builder',      label: 'Resume builder',       desc: 'ATS-friendly Ayurveda CV',                       icon: FileText },
        ],
      }],
      more: [
        { href: '/jobs/salary-calculator',        label: 'Salary Calculator' },
        { href: '/jobs/licensing',                label: 'Licensing (DHA/DOH/MOH)' },
        { href: '/jobs/government-ayurveda-jobs', label: 'Government Jobs' },
        { href: '/jobs/walk-in',                  label: 'Walk-in Interviews' },
        { href: '/jobs/immediate-hiring',         label: 'Urgent Hiring' },
        { href: '/jobs/freshers',                 label: 'Freshers' },
        { href: '/jobs/remote',                   label: 'Remote' },
        { href: '/jobs/locum',                    label: 'Locum' },
      ],
    },
