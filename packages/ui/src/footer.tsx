...
const COLS: Array<{ heading: string; links: Array<{ href: string; label: string }> }> = [
  ...
  },
  {
    ...
    links: [
      ...
      { href: '/jobs/government-ayurveda-jobs',        label: 'Govt Jobs' },
      { href: '/jobs/upload-poster',                   label: 'Post from Poster' },
      { href: '/jobs/quick-post',                      label: 'Quick Post' },
      { href: '/jobs/talent',                          label: 'Talent Directory' },
      { href: '/jobs/interview-questions',             label: 'Interview Questions' },
